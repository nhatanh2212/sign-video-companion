...
function TranscriptSignPlayer({ videoUrl, segments, onBack }: TranscriptSignPlayerProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid items-stretch gap-6 md:grid-cols-5">
        ...
        <div className="flex items-center justify-center rounded-xl border border-slate-800 bg-black p-3 md:col-span-2">
          {activeSegment?.status === 'done' && activeSegment.poseUrl ? (
            <SignAvatar
              ...
              loop
              playing={isPlaying}
              className="block aspect-square h-full"
            />
